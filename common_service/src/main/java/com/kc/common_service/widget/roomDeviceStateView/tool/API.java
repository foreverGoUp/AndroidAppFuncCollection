...
public class API {
    ...
    public static final String DEVICE_WINDOW = "window";//窗户
    public static final String DEVICE_CURTAIN = "curtain";//窗帘
    public static final String DEVICE_OUTLET = "outlet";//插座
    ...
    public static final String DEVICE_RELAY = "relay";//16路继电器
    public static final String DEVICE_VALVE = "valve";// 加湿器阀门
    public static final String DEVICE_VALVE_WIND = "valvew";// 新风阀门
    //设备小类型
//    public static final String WL_FAKE_DEVICE_TYPE_HUMIDIFIER = "valve";
    ...
    //b3小类型
    public static final String DEVICE_B3_PM = "pm";//pm2.5
    public static final String DEVICE_B3_T = "t";// 温度
    public static final String DEVICE_B3_H = "h";// 湿度
    public static final String DEVICE_B3_CO2 = "co2";// 痒度
    public static final String DEVICE_B3_TVOC = "tvoc";// tvoc
}
